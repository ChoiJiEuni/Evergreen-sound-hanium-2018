...
public class inputDB_PHPActivity extends AppCompatActivity {
    private static String IP_ADDRESS = "http://10.0.2.2/ttest/process.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_db__php);
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(inputDB_PHPActivity.this,
